...
namespace work.ctrl3d.Logger
{
    ...
    public class TcpServerLogger : ILogger
    {
        ...
        public string Prefix { get; set; } = "[TCPServer]";
        public Color LogColor { get; set; } = Color.yellow;
        ...
        {
            return $"TcpServerLogger[Enabled={IsLogEnabled}, Level={LogLevel}, Prefix=\"{Prefix}\"]";
        }
    }
}